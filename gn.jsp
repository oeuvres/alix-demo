...
Une concordance limitée à 2000 occurrences est livrée à la suite, pour se faire une meilleure idée de ce qui est capturé.
    ...
    <%
      List<Map.Entry<String,Terminfos>> list = dico.entriesByCount();
        int limit = 200;
        int i = 1;
        float franfreq = 0;
        float myfreq;
        ...
        for ( Map.Entry<String,Terminfos> entry: list ) {
      orth = entry.getKey();
      out.println( "<tr>" );
      out.print( "<td>" );
      out.print( i );
      ...
      out.println( "</td>" );
      out.print( "<td align=\"right\">" );
      out.print( entry.getValue().count() );
      out.println( "</td>" );
      lexie = null;
      franfreq=0;
      myfreq = 1000000.0f*( entry.getValue().count() + entry.getValue().count2() ) / total;
      out.print( "<td align=\"right\">" );
