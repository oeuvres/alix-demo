...
(function(global) {
  ...
  var WordCloud = function WordCloud(elements, options) {
      ...
      switch (settings.shape) {
        ...
        */
        ...
        case 'diamond':
          ...
          // +0+..+2*PI
          settings.shape = function shapeDiamond(theta) {
    ...
    console.log( minRotation +  ( Math.floor( (Math.random() * rotationSteps) )) * rotationRange/(rotationSteps-1) );
    console.log( minRotation + " " + rotationSteps + " " + Math.floor( (Math.random() * rotationSteps ) ) );
